...
```
cd existing_repo
git remote add origin https://gitlab.com/FloThePro/dascml_assignment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/FloThePro/dascml_assignment/-/settings/integrations)
